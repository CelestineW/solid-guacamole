...
public class NationalAcceptanceTest implements Validatable {
    private String date;
    ...
    public List<ValidationError> validate(@NonNull Context context) {
        return aggregateErrors(
                ...
                mapErrorsForSection(result1, R.string.exam_result_1, context),
                mapErrorsForSection(result2, R.string.exam_result_2, context),
                mapErrorsForSection(result3, R.string.exam_result_3, context),
                mapErrorsForSection(result4, R.string.exam_result_4, context),
                mapErrorsForSection(result5, R.string.exam_result_5, context),
                mapErrorsForSection(result6, R.string.exam_result_6, context)
        );
    }
}
