...
public final class StPetersburgAddress implements Validatable {
    private String streetAddress;
    private String apartmentNumber;
    private String city; // ???? it's in St. Petersburg ???????
    ...
    public List<ValidationError> validate(@NonNull Context context) {
        return aggregateErrors(
                ...
                nonEmptyString(apartmentNumber, R.string.apartment_number, context),
